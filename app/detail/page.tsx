      ...
      {/* <DetailB>
        ...
        <DetailBContent>
          ...
          <div>
            ...
            듣는 편입니다. 가사가 없는 음악은 소리와 멜로디로만 이루어져 있어서
            논리적인 사고와 집중력을 높여주고, 코딩할 때 문제 해결에 더 집중할
            수 있습니다. 책상 위에 항상 있는 아이템은 다이어리와 노트인데요.
            저는 계획 세우는 것을 좋아해, 일을 할 때에도 철저하게 마감일을
            설정하는 편입니다. 코드 설계, 개발, 테스트와 같은 여러 프로세스를
            차근차근 계획하여 일정을 지연시키지 않고, 꼼꼼하게 개발하려고
            노력합니다. 개발 과정에서 중복 변수 선언, 프로세스 이해 부족 등의
            경우에 노트에 도식화하여 이해, 설계하면 이해력이 높아져 업무의 능률
            또한 올라갑니다. 간단하지만 직접 도식화하는 방식으로 업무를 처리할
            때, 보다 효율적이고 원활한 작업이 가능합니다.
          </div>
        </DetailBContent>
        <DetailBFooter>
          <HStack spacing={"15px"}>
